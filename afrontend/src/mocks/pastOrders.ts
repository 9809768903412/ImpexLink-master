...
const MOCK_ORDER_BLUEPRINTS = [
  {
    ...
    items: [
      { itemId: '205', itemName: 'Paint brush 1"', unit: 'pcs', quantity: 50, unitPrice: 25 },
      { itemId: '214', itemName: 'Steel brush', unit: 'pcs', quantity: 12, unitPrice: 50 },
      { itemId: '216', itemName: 'Cotton rags', unit: 'bundle', quantity: 25, unitPrice: 60 },
    ],
  },
  {
    id: 'mock-past-002',
    ...
    items: [
      { itemId: '220', itemName: 'Seal Tech AW 5 ltrs', unit: 'pail', quantity: 6, unitPrice: 13550 },
      { itemId: '209', itemName: 'Spatula 2"', unit: 'pcs', quantity: 20, unitPrice: 25 },
    ],
  },
  {
    id: 'mock-past-003',
    ...
    items: [
      { itemId: '201', itemName: 'Paint brush 1"', unit: 'pcs', quantity: 40, unitPrice: 25 },
      { itemId: '206', itemName: 'Paint roller 7" w/ handle', unit: 'pcs', quantity: 18, unitPrice: 100 },
      { itemId: '212', itemName: 'Palette pair 4"', unit: 'pairs', quantity: 10, unitPrice: 50 },
    ],
  },
];
